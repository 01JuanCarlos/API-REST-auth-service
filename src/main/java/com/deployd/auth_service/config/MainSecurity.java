package com.deployd.auth_service.config;

import com.deployd.auth_service.jwt.JwtEntryPoint;
import com.deployd.auth_service.jwt.JwtTokentFilter;
import com.deployd.auth_service.service.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/auth/**","/email-password/**").permitAll() // Rutas públicas
